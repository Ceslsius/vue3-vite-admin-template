 ...
 * @LastEditTime: 2021-04-09 14:15:43
-->
<template>
...
import { exportFansList, getFansList } from '../api'
...
export default defineComponent({
  ...
  props: {
    info: {
      required: true,
      type: Object as PropType<TaskListInfo>,
    },
  },
  setup(props) {
    const form = reactive({
    ...
    const {
      ...
      sizeChange,
      exportExcel,
    } = useTable(form, getFansList, {
      exportExcelFunc: exportFansList,
